...
import { X, Loader2, PieChart, DollarSign, Calendar } from 'lucide-react';
          ...
          <div className="bg-gradient-to-r from-green-500/20 to-transparent p-6 border-b border-gray-800/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-white">Add Budget</h1>
                  <p className="text-gray-400 text-sm">Tetapkan budget untuk target keinginan</p>
                </div>
              </div>
              <button
                onClick={onClose}
          ...
          <form className="p-6" onSubmit={handleSubmit}>
            ...
            <div className="flex gap-3 mt-6 pt-6 border-t border-gray-800">
              ...
              <button 
                type="submit"
                disabled={loading}
                className="flex-1 bg-gradient-to-r from-green-600 to-emerald-500 hover:from-green-500 hover:to-emerald-400 text-white py-3 rounded-xl font-bold transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg hover:shadow-green-500/30"
              >
                {loading ? (
                  <>
