          ...
          <div className="flex gap-3">
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <button
                ...
                className="group px-5 py-2.5 bg-zinc-900 border border-zinc-800 rounded-xl text-sm font-semibold hover:border-emerald-500/50 hover:text-emerald-400 transition-all duration-300 flex items-center justify-center gap-2 shadow-sm w-full sm:w-auto"
              >
              ...
              <button
                ...
                className="group px-5 py-2.5 bg-zinc-900 border border-zinc-800 rounded-xl text-sm font-semibold hover:border-red-500/50 hover:text-red-400 transition-all duration-300 flex items-center justify-center gap-2 shadow-sm w-full sm:w-auto"
              >
          ...
          <div className="space-y-4">
            {notifications.map((notif) => {
              ...
              return (
                <div
                  key={id}
                  className={`group relative overflow-hidden transition-all duration-300 rounded-2xl border ${isRead
