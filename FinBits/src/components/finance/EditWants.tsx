// ui/EditWants.tsx (new component untuk edit wants)
...
interface EditWantsProps {
  onClose: () => void;
  onSave: (name: string, price: number, imageUrl: string) => void;
  ...
  return (
    ...
    >
      <div className="bg-[#121212] text-white p-8 rounded-xl shadow-2xl w-full max-w-sm border border-gray-800 relative my-8">
        ...
        <h1 className="text-[#599EFF] text-3xl font-bold text-center mb-8">
          Edit Wants
        </h1>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div 
              ...
              className="w-full aspect-[4/3] bg-gray-900/50 border-2 border-dashed border-gray-700 rounded-lg flex flex-col items-center justify-center group cursor-pointer hover:border-[#599EFF] transition-colors mb-3 overflow-hidden"
            >
              {formData.imageUrl ? (
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-900/50 border border-gray-700 rounded-lg p-3 outline-none focus:border-[#599EFF] transition-colors"
