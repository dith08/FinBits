...
interface EditIncomeProps {
  onClose: () => void;
  onSave: (updatedIncome: { label: string; value: string }) => void;
  initialData: {
    label: string;
    value: string;
  };
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-[#2a2f36] text-gray-900 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-[#599EFF] transition-all"
                required
              />
          ...
          <div className="pt-4">
            <div className="flex gap-3">
              ...
              <button
                type="submit"
                className="flex-1 bg-[#599EFF] hover:bg-[#478cff] text-white font-bold py-3 rounded-lg transition-all shadow-lg"
              >
                Update Income
              </button>
            </div>
