...
const DeleteModalHabbits: React.FC<DeleteModalHabbitsProps> = ({ isOpen, onClose, onConfirm, count = 1 }) => {
    ...
    >
      <div className="w-[400px] rounded-[32px] bg-[#121212] p-8 text-center shadow-2xl">
        ...
        <p className="text-gray-400 text-sm leading-relaxed mb-8 px-4">
          {count > 1 
            ? `${count} habit yang dipilih akan dihapus secara permanen dari sistem.`
...
export default DeleteModalHabbits;