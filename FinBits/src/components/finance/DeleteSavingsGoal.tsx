...
interface DeleteSavingsGoalProps {
  onClose: () => void;
  onConfirm: () => Promise<void>;
  goalName: string;
}

const DeleteSavingsGoal: React.FC<DeleteSavingsGoalProps> = ({ onClose, onConfirm, goalName }) => {
    ...
    >
      <div className="bg-[#121212] text-white p-8 rounded-xl shadow-2xl w-full max-w-md border border-gray-800 relative">
        ...
        <p className="text-gray-400 text-center mb-6">
          Anda akan menghapus goal <span className="font-semibold text-white">"{goalName}"</span>. Tindakan ini tidak dapat dibatalkan.
        </p>

        <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4 mb-6">
          <p className="text-red-400 text-sm">
            ⚠️ Semua data tabungan untuk goal ini akan dihapus secara permanen.
          </p>
        </div>
